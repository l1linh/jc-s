...
Route::get('/support', [ContentController::class, 'show'])->defaults('path', 'support')->name('support');
Route::get('/message', [ContentController::class, 'show'])->defaults('path', 'message')->name('message');
Route::get('/step', [ContentController::class, 'show'])->defaults('path', 'step')->name('step');
